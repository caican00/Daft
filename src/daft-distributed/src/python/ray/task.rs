...
#[pyclass(module = "daft.daft", name = "RaySwordfishActorHandle")]
pub(crate) struct PyRaySwordfishActorHandle {
    pub handle: Py<PyAny>,
}

#[pymethods]
impl PyRaySwordfishActorHandle {
    #[new]
    ...
    #[getter]
    fn handle(&self, py: Python) -> Py<PyAny> {
